...
export const characters: CharacterConfig[] = [
  // Team 1
  { playerIndex: 1, team: 1, name: 'Seonjae', startCoord: { col: 1, row: 1 }, moveRange: 6, spritePath: `${import.meta.env.BASE_URL}textures/seonjae_base.png`, hp: 100, strength: 10, intellect: 8, defense: 1, resistance: 1, attackRange: 2, skills: [{ name: SKILL_NAMES.REVEILLE, range: 3, targetType: 'ally' as const }] },
  { playerIndex: 3, team: 1, name: 'Aerin',   startCoord: { col: 1, row: 3 }, moveRange: 5, spritePath: `${import.meta.env.BASE_URL}textures/aerin_base.png`,   hp: 90,  strength: 7,  intellect: 3, defense: 3, resistance: 2, attackRange: 1, skills: [] },
  // Team 2
