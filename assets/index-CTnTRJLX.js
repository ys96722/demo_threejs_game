...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function _o(){return new At({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ya(),fragmentShader:`
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function vo(){return new At({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ya(),fragmentShader:`
...
`].filter(Fi).join(`
`)),a=oa(a),a=wo(a,t),a=Po(a,t),o=oa(o),o=wo(o,t),o=Po(o,t),a=Io(a),o=Io(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Ei.BlurDirectionX=new Ce(1,0);Ei.BlurDirectionY=new Ce(0,1);const mm={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
